...
Route::prefix('admin')->name('admin.')->group(function () {
    Route::group(['middleware' => 'guest'], function () {
        ...
        Route::post('forgot_password', 'Admin\Auth\ForgotPasswordController@sendCodeResetPassword');
        Route::get('reset_password', 'Admin\Auth\ForgotPasswordController@getResetPassword')->name('reset_password');
        Route::post('reset_password', 'Admin\Auth\ForgotPasswordController@postResetPassword');
    });
